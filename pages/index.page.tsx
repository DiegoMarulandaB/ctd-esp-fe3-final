...
//     status: 'OK',
//     data: {
//       results: [response], // Aquí debes envolver `response` dentro de un array
//       total: response.length
//     }
//   }
//   return {
//     props: {
//       initialComics: marvelApiResponse.data.results.flat(), // Para aplanar el array de arrays
//       initialTotal: marvelApiResponse.data.total
//     }
//   }
// }
...
const Index: NextPage<IndexProps> = ({ initialComics, initialTotal }: IndexProps) => {
  ...
  //         status: 'OK',
  //         data: {
  //           results: [response], // Aquí también debes envolver `response` dentro de un array
  //           total: response.length
  //         }
  //       }
  //       setComics(marvelApiResponse.data.results.flat())
  //       setTotal(marvelApiResponse.data.total)
  //     } catch (error) {
  //       console.error('Error fetching comics:', error)
  //     }
