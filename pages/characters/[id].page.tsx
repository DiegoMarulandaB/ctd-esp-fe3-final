...
import { type Result } from '../../features/types/characters.types'
...
const CharacterDetail: NextPage<CharacterProps> = ({ character }) => {
  return (
        <LayoutGeneral>
            <Card
                    elevation={0}
                    sx={{ display: 'flex', alignItems: 'center', padding: 2, borderRadius: '16px', marginTop: '70px', marginBottom: '15px', boxShadow: '0 2px 8px 0 #c1c9d7, 0 -2px 8px 0 #cce1e9', width: '60%', height: '70%' }}
                >
                    <CardMedia
                        component="img"
